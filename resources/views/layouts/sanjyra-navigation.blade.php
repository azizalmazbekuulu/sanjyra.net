<nav x-data="{ open: false }" class="border-b border-gray-300 shadow-xl w-full" style="background:cyan;">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a class="pl-2 font-extrabold text-base md:text-xl" href="{{ route('index') }}">
                        <img src="{{ asset('storage/logos/apple-touch-icon.png') }}" width="50" height="50" alt="Sanjyra.net">
                    </a>
                </div>
